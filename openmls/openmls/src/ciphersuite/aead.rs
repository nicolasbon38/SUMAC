...
#[cfg_attr(any(feature = "test-utils", feature = "sumac", test), derive(PartialEq, Eq, Clone))]
...
#[cfg(any(not(feature = "crypto-debug"), not(feature = "sumac")))]
...
#[cfg_attr(feature = "sumac", derive(Default))]
...
impl AeadKey {
    ...
    #[cfg(any(feature = "test-utils", feature="sumac", test))]
