...
use sumac_rs::{
    ...
    sumac::{
        ...
        regeneration::{EncryptedCombinedPath, EncryptedRegenerationSet, EncryptedRegenerationTree, RegenerationTree},
        setup_sumac,
        sumac_operations::{
            add_admin::{add_admin_committer, add_admin_new_admin, add_admin_only_one_other_admin, add_admin_only_one_standard_user, add_admin_other_admins},
            add_user::{
                add_user_committer, add_user_new_user, add_user_one_other_admin,
                add_user_one_standard_user, add_user_other_admins, add_user_standard_users,
            },
        },
...
fn add_admin_sumac_new_admin(
    ...
    add_admin_new_admin(provider, ciphersuite, &state.all_admins, &mut state.all_admin_groups, commit_unicast, encrypted_tree, username_new_admin).unwrap()
                ...
                |b, &n_users| {
                    b.iter_batched(
                        ...
                        |(mut local_state, commit_broadcast, target_admin)| {
                            black_box(add_admin_sumac_one_other_admin(&mut local_state, &provider, ciphersuite, commit_broadcast, &target_admin))
                        },
                        criterion::BatchSize::LargeInput,
                    )
                },
...
criterion_group!(bench_sumac, /*benchmark_add_admin,*/ benchmark_add_user);
